...
def save_cps(state, is_best, checkpoint, filename='checkpoint.pth.tar'):
...
def main():
    ...
    parser.add_argument('--arch', default='wideresnet', type=str,choices=['wideresnet', 'resnext'])
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,model, optimizer, ema_model, scheduler):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank in [-1, 0]:
            ...
            print("epoch[",epoch,']',"train loss:",losses.avg,"test_acc:",test_acc,"test_loss:",test_loss)
